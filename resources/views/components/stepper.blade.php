...
<ol class="flex items-center w-full">
    <li class="flex w-full items-center after:content-[''] after:w-full after:h-1 after:border-b after:border-4 after:inline-block after:border-violet-600">
        <span class="flex items-center justify-center w-10 h-10 rounded-full lg:h-12 lg:w-12 bg-violet-600 shrink-0">
