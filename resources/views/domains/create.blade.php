    ...
    <div class="flex space-x-3 min-h-screen">
        <div class="w-3/5 pb-6 pt-2">
            ...
            <x-card class="max-w-xl">
                <x-card-header>New Allowed Domain</x-card-header>
                <x-forms.form method="POST" action="/settings/domains">
                    <x-forms.input-field class="w-full" name="name" type="text" label="Name of System"
                        placeholder="--"
                        required
                    />
                    <x-forms.input-field class="w-full" name="host" type="text" label="Host or Domain"
                        placeholder="--"
                        required
                    />
